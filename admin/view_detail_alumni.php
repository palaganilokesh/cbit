...
<script language="javascript">	
	function update1() //for update download details
	{
		...
		document.frmedtalumniid.submit();
	}
</script>
...
<section class="content">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">View alumni</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="#">Home</a></li>
						<li class="breadcrumb-item active">View alumni</li>
					</ol>
				</div><!-- /.col -->
			</div><!-- /.row -->
		</div><!-- /.container-fluid -->
	</div>
	<form name="frmedtalumniid" id="frmedtalumniid" method="post" action="<?php $_SERVER['PHP_SELF'];?>" onSubmit="return performCheck('frmedtalumniid', rules, 'inline');">
				...
				<div class="row justify-content-center">
					<div class="col-md-12">
						...
						<div class="form-group row">
							...
							<div class="col-sm-8">
								<?php echo $rowsalumni_mst['alumnim_desc'];?>
							</div>
						</div>
						<div class="form-group row">
							<label for="txtname" class="col-sm-2 col-md-2 col-form-label">Link</label>
							<div class="col-sm-8">
								<?php echo $rowsalumni_mst['alumnim_lnk'];?>
							</div>
						</div>
                        <div class="form-group row">
							<label for="txtname" class="col-sm-2 col-md-2 col-form-label">Batch</label>
							<div class="col-sm-8">
								<?php echo $rowsalumni_mst['alumnim_batch'];?>
							</div>
						</div>
                        <div class="form-group row">
							<label for="txtname" class="col-sm-2 col-md-2 col-form-label">Job</label>
							<div class="col-sm-8">
						...
						<div class="form-group row">
							...
							<div class="col-sm-8">
								...
								{
									echo "<img src='$alumniimgpath' width='100pixel' height='100pixel'>";
								}
								else
								{
						...
						<div class="form-group row">
							...
							<div class="col-sm-8">
								<?php echo $rowsalumni_mst['alumnim_prty'];?>
							</div>
						</div>
						<div class="form-group row">
