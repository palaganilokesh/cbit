...
if(isset($_POST['btnpopupsbmt']) && (trim($_POST['btnpopupsbmt']) != "") && isset($_POST['txtname']) && (trim($_POST['txtname']) != "") && isset($_POST['txtprior']) && (trim($_POST['txtprior']) != ""))
{
  ...
  include_once "../database/iqry_popup_mst.php";
}
...
<script language="javascript" type="text/javascript">
	function funcChkDupName()
	{
		...
		if(name != "")
		{
			var url = "chkduplicate.php?popupname="+name;
...
<section class="content">
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">Add popup</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
			...
			<form name="frmaddvehbrnd" id="frmaddvehbrnd" method="post" action="<?php $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data" onSubmit="return performCheck('frmaddvehbrnd', rules, 'inline');">
				<div class="col-md-12">
					<div class="row justify-content-center align-items-center">
							...
							<div class="row mb-2 mt-2">
								...
								<div class="col-sm-9">
									<div class="custom-file">
										<input name="flepopupimg" type="file" class="form-control" id="flepopupimg" maxlength="250">
									</div>
								</div>
							</div>
						</div>
						...
						<p class="text-center">
							<input type="Submit" class="btn btn-primary" name="btnpopupsbmt" id="btnpopupsbmt" value="Submit">
							&nbsp;&nbsp;&nbsp;
							<input type="reset" class="btn btn-primary" name="btnpopupreset" value="Clear" id="btnpopupreset">
							&nbsp;&nbsp;&nbsp;
