	   ...
	   isset($_REQUEST['cntstart']) && trim($_REQUEST['cntstart'])!=""){
		...
		if($optn !="" && $lstdpt != ""){
		 ...
		 $sqrypgcnts_dtl="SELECT
								...
								pgcntsd_dskimg,pgcntsd_tabimg,pgcntsd_mobimg,prodmnlnksm_name
					  	 from
          ...
          <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <?php echo $db_pgcntlnk; ?>
						...
						<div class="form-group row">
						<label for="txtname" class="col-sm-2 col-md-2 col-form-label">Header Desktop Images</label>
						<div class="col-sm-8">
						<?php
						...
						<div class="form-group row">
						<label for="txtname" class="col-sm-2 col-md-2 col-form-label">Header Tablet Images</label>
						<div class="col-sm-8">
						<?php
						...
						<div class="form-group row">
						<label for="txtname" class="col-sm-2 col-md-2 col-form-label">Header Mobile Images</label>
						<div class="col-sm-8">
						<?php
