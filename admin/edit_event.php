...
/*****header link********/
if (
	isset($_POST['btnedtevnt']) && (trim($_POST['btnedtevnt']) != "") &&
...
$sqryevnt_mst = "SELECT
						...
						evntm_sts,evntm_lnk,evntm_typ,evntm_dept,evntm_acyr
				    from
						evnt_mst
	                where
						evntm_id=$id";
...
<head>
	...
	<script language="javascript" type="text/javascript">
		...
		rules[5] = 'lstacyr:Academic year|required|Select Academic Year';
					...
					<div class="row justify-content-center">
						<div class="col-md-12">
							<div class="row mb-2 mt-2">
								...
								<div class="col-sm-9">
									<input name="txttyp" disabled type="text" value="<?php if ($rowsevnt_mst['evntm_typ'] == 'e') {
																																			echo "Event";
																																		} else {
																																			echo "News";
																																		} ?>" class="form-control" id="txttyp" size="45" maxlength="240">
						...
						<div class="col-md-12">
							<div class="row mb-2 mt-2">
								...
								<div class="col-sm-9">
									<input name="txtname" type="text" value="<?php echo $rowsevnt_mst['evntm_name']; ?>" class="form-control" id="txtname" size="45" maxlength="240" onBlur="funcChkDupName()">
							...
							<div class="row mb-2 mt-2">
								...
								<div class="col-sm-9">
									...
									<select name="lstacyr" id="lstacyr" class="form-control">
										...
										?>
												<option value="<?php echo $aynm; ?>" <?php if ($rowsevnt_mst['evntm_acyr'] == $aynm) echo 'selected'; ?>><?php echo $aynm; ?></option>
										...
										<table width="100%" border="0" cellspacing="3" cellpadding="3">
											<tr bgcolor="#FFFFFF">
												...
												<td width='10%' align="center">
													...
													<input type="button" name="btnrmv" value="REMOVE" onclick="rmvimg('<?php echo $evntimgdid; ?>')">
												</td>
