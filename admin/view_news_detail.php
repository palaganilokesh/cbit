...
nwsm_dwnfl,date_format(nwsm_dt,'%d-%m-%Y') as nwsm_dt,nwsm_dept,nwsm_acyr
from
nws_mst
                ...
                <div class="row justify-content-center">
                    <div class="col-md-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <?php echo $rowsprodscat_mst['nwsm_acyr']; ?>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <?php
                                $imgnm = $rowsprodscat_mst['nwsm_img'];
                        ...
                        <div class="form-group row">
                            <label for="txtname" class="col-sm-2 col-md-2 col-form-label">File</label>
                            <div class="col-sm-8">
                                <?php echo $rowsprodscat_mst['nwsm_dwnfl']; ?>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                ...
                                else if ($rowsprodscat_mst['nwsm_typ'] == 5) {
                                    echo "Department Notifications";
                                } ?>
                            </div>
                        </div>
