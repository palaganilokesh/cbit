			...
			<div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-12 order-md-1 order-2">
				...
				<div class="campus-content pr-20 ">
					...
					if (isset($_REQUEST['phtid']) && trim($_REQUEST['phtid']) != "") {
						...
						$sqryphtcat_mst1 = "SELECT phtd_id,phtd_phtcatm_id,phtd_type,phtd_name,phtd_sts,phtd_rank from  vw_phtd_phtm_mst where  (phtd_phtcatm_id  ='$pt_id' or phtd_name='$pht_id')  and 	phtd_sts = 'a'  group by phtd_id  order by 	phtd_rank asc";
								...
								<div class="demo-gallery ">
									<ul id="" class="list-unstyled row gx-xxl-1 gx-xl-1 gx-lg-1 gx-md-2 gx-0">
										...
										while ($srowsphtcat_dtl1 = mysqli_fetch_assoc($srsphtcat_dtl1)) {
											$phtid         = $srowsphtcat_dtl1['phtd_id'];
											$pht_nm        = $srowsphtcat_dtl1['phtd_name'];
											$dept_pht_url = funcStrRplc($pht_nm);
											//$phtid         = $srowsphtcat_dtl1['phtd_desc'];
											$sqrypht_dtl = "SELECT phtm_id,phtm_simgnm,phtm_simg,phtm_sts,phtm_prty from  vw_phtd_phtm_mst where  phtm_phtcatm_id  ='$pt_id' and phtm_phtd_id='$phtid' and	phtm_sts = 'a'   order by 	phtm_prty asc limit 1";
										...
										?>
											...
											<li class="col-xxl-4 col-lg-4 col-md-4 col-6 mb-2" data-responsive="<?php echo $galryimages; ?> 375, <?php echo $galryimages; ?> 480, <?php echo $galryimages; ?> 800 " data-src="<?php echo $galryimages; ?> " data-sub-html="<h4>Category 1</h4>">

											<a href="<?php echo $rtpth . $dept_pht_url .'/'.$pht_nm_url.'_'.$pht_id .'/' . $cn_mn_url . '/' . $cn_cat_url . '/' . $cn_scat_url . '_' . $phtid; ?>">
													<img class="img-responsive w-100" src="<?php echo $galryimages; ?>">
													<div class="demo-gallery-poster">

													</div>
												</a>
												<h2 class="cat-caption"><?php echo $pht_nm; ?></h2>
