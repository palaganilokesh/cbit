	...
	?>
							...
							<div class="col-lg-6 col-md-6">
								<div class="single-news-card">
									<div class="news-img">
										<a href="<?php echo $rtpth?>announcements-details.php?notify_typ=<?php echo $notify_typ;?>&notid=<?php echo $ancmt_id;?>"><img src="<?php echo $notify_imgpth;?>" alt="Image"></a>
									</div>
									<div class="announcements-content">
										...
										<a href="<?php echo $rtpth?>announcements-details.php?notify_typ=<?php echo $notify_typ;?>&notid=<?php echo $ancmt_id;?>">
											<h3><?php echo $ancmt_nm;?></h3>
										</a>
										<a href="<?php echo $rtpth?>announcements-details.php?notify_typ=<?php echo $notify_typ;?>&notid=<?php echo $ancmt_id;?>" class="read-more-btn">Read More<i class="flaticon-next"></i></a>
									</div>
								</div>
							</div>
<?php } ?>
